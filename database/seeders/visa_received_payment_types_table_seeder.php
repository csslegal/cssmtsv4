...
class visa_received_payment_types_table_seeder extends Seeder
{
    /**
    ...
    public function run()
    {
        DB::table('visa_received_payment_types')->insert(
            ['id' => 1, 'name' => "Danışmanlık Hizmet Bedeli", 'orderby' => 1,],
        );
        DB::table('visa_received_payment_types')->insert(
            ['id' => 2, 'name' => "Konsolosluk Vize Harcı", 'orderby' => 2,],
        );
        DB::table('visa_received_payment_types')->insert(
            ['id' => 3, 'name' => "Danışmanlık Hizmet Bedeli & Konsolosluk Vize Harcı", 'orderby' => 3,],
        );
        DB::table('visa_received_payment_types')->insert(
