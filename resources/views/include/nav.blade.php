    ...
    <ul class="nav flex-column">
        @if (session('userTypeId') == 1)
            <li class="nav-item pt-1">
                <a class="nav-link {{ request()->is('yonetim') || request()->is('yonetim/vize') || request()->is('yonetim/harici') || request()->is('yonetim/web') || request()->is('yonetim/dilokulu') ? 'active bg-dark text-white' : '' }}"
                    aria-current="page" href="/yonetim">
                    <i class="bi bi-house-fill"></i>&nbspYönetim İşlemleri</a>
            </li>
        @else
            <li class="nav-item pt-1">
                <a class="nav-link {{ request()->is('kullanici') ? 'active bg-dark text-white' : '' }}"
        ...
        <li class="nav-item pt-1">
            <a class="nav-link {{ request()->is('musteri/sorgula') ? 'active bg-dark text-white' : '' }}"
                href="/musteri/sorgula">
                <i class="bi bi-search"></i>&nbspMüşteri Sorgula</a>
        </li>
        <li class="nav-item pt-1 ">
            <a class="nav-link {{ request()->is('musteri/create') ? 'active bg-dark text-white' : '' }}"
                href="/musteri/create">
                <i class="bi bi-person-plus-fill"></i>&nbspMüşteri Kayıt</a>
        </li>
        @if (session('userTypeId') == 1)
            <li class="nav-item pt-1">
                <a class="nav-link {{ request()->is('yonetim/profil') ? 'active bg-dark text-white' : '' }}"
                    href="/yonetim/profil">
                    <i class="bi bi-person-fill"></i>&nbspProfilim</a>
            </li>
        @else
            <li class="nav-item pt-1">
                <a class="nav-link {{ request()->is('kullanici/profil') ? 'active bg-dark text-white' : '' }}"
                    href="/kullanici/profil">
                    <i class="bi bi-person-fill"></i>&nbspProfilim</a>
            </li>
            <li class="nav-item pt-1">
                <a id="duyuruSayisi"
                    class="nav-link {{ request()->is('kullanici/duyuru') ? 'active bg-dark text-white' : '' }}"
        ...
        <li class="nav-item pt-1">
            <a class="nav-link {{ request()->is('cikis') ? 'active bg-dark text-white' : '' }}" href="/cikis">
