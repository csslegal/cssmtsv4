...
@section('content')
    ...
    <div class="card card-primary mb-3">
        <div class="card-header bg-primary text-white">
            Diller
            <a class="float-end text-white" href="/yonetim/language/create">Ekle</a>
        </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group" role="group" aria-label="Basic example">
                                    ...
                                    <a href="/yonetim/language/{{ $kayit->id }}/edit">
                                        <button data-bs-toggle="tooltip" data-bs-placement="top" title="Düzenle">
                                            <i class="bi bi-pencil-square "></i>
                                        </button>
                                    </a>
                                    <form action="/yonetim/language/{{ $kayit->id }}" method="post">
                                        @method('DELETE')
                                        @csrf
