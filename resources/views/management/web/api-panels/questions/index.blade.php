...
@section('content')
    ...
    <div class="card mb-3">
        <div class="card-header bg-danger text-white">Sorular
            <a class="float-end text-white" href="questions/create">Ekle</a>
        </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group" role="group" aria-label="Basic example">
                                    <a href="questions/{{ $result->id }}/edit">
                                        <button data-bs-toggle="tooltip" data-bs-placement="top" title="Düzenle">
                                            <i class="bi bi-pencil-square "></i>
                                        </button>
                                    </a>
                                    <form action="questions/{{ $result->id }}" method="post">
                                        @method('DELETE')
                                        @csrf
