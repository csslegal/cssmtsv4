...
@section('content')
    <nav aria-label="breadcrumb">
        <ol id="breadcrumb" class="breadcrumb p-2">
            ...
            <li class="breadcrumb-item active">
                <a href="/yonetim/web/api-panels/{{ $webPanel->id }}/questions">Sorular</a>
            </li>
    ...
    <div class="card mb-3">
        ...
        <div class="card-body">
            <form method="POST" action="/yonetim/web/api-panels/{{ $webPanel->id }}/questions/{{ $question->id }}">
                @method('PUT')
                @csrf
                <div class="mb-3">
                    <label class="form-label">Başlık</label>
                    <input type="text" value="@isset($question){!! $question->title !!}@endisset"
                ...
                <div class="mb-3">
                    ...
                    <input type="text" value="@isset($question){!! $question->description !!}@endisset"
                ...
                <div class="mb-3">
                    <div class="row">
                        <div class="col-6">
                            ...
                            <input type="text"
                                value="@isset($question){!! $question->image !!}@endisset" name="image"
                                class="form-control">
                        </div>
                        <div class="col-6">
                            <label class="form-label">Resim</label><br />
                            <img src="@isset($question){!! $question->image !!}@endisset"
