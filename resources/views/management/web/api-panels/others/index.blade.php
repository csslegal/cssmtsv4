...
@section('content')
    <nav aria-label="breadcrumb">
        <ol id="breadcrumb" class="breadcrumb p-2">
            ...
            <li class="breadcrumb-item active" aria-current="page">Diğer Yazılar</li>
        </ol>
    </nav>

    <div class="card mb-3">
        <div class="card-header bg-danger text-white">Diğer Yazılar
            <a class="float-end text-white" href="others/create">Ekle</a>
        </div>
