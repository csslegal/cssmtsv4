...
@section('content')
    <nav aria-label="breadcrumb">
        <ol id="breadcrumb" class="breadcrumb p-2">
            ...
            <li class="breadcrumb-item active">
                <a href="/yonetim/web/api-panels/{{ $webPanel->id }}/others">Diğer Yazılar</a>
            </li>
    ...
    <div class="card mb-3">
        ...
        <div class="card-body">
            <form method="POST" action="/yonetim/web/api-panels/{{ $webPanel->id }}/others/{{ $other->id }}">
                @method('PUT')
                @csrf
                <div class="mb-3">
                    <label class="form-label">Başlık</label>
                    <input type="text" value="@isset($other){!! $other->title !!}@endisset"
                ...
                <div class="mb-3">
                    ...
                    <input type="text" value="@isset($other){!! $other->description !!}@endisset"
                ...
                <div class="mb-3">
                    <div class="row">
                        <div class="col-6">
                            ...
                            <input type="text"
                                value="@isset($other){!! $other->image !!}@endisset" name="image"
                                class="form-control">
                        </div>
                        <div class="col-6">
                            <label class="form-label">Resim</label><br />
                            <img src="@isset($other){!! $other->image !!}@endisset"
