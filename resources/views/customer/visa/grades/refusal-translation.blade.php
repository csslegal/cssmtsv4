        ...
        <div class="card-body scroll">
            <form action="" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="sayfa_sayisi" class="form-control" placeholder="Sayfa sayısı girin"
                        value="{{ old('sayfa_sayisi') }}" />
                    @error('sayfa_sayisi')
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="tercume_sayfa_sayisi" class="form-control" placeholder="Tercüme sayfa sayısı girin"
                        value="{{ old('tercume_sayfa_sayisi') }}" />
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="tercume_kelime_sayisi" class="form-control" placeholder="Tercüme kelime sayısı girin"
                        value="{{ old('tercume_kelime_sayisi') }}" />
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="tercume_karakter_sayisi" class="form-control" placeholder="Tercüme karakter sayısı girin"
                        value="{{ old('tercume_karakter_sayisi') }}" />
