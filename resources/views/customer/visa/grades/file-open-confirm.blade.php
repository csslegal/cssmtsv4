...
@section('content')
    <nav aria-label="breadcrumb">
        <ol id="breadcrumb" class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Dosya Açma Onayı</li>
        </ol>
    </nav>
    <div class="card card-dark mb-3">
        <div class="card-header bg-dark text-white">Dosya Açma Onayı İşlemleri</div>
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 ">
                    <div class="card border-dark mb-3">
                        <div class="card-body">
                            ...
                            <p>İptal edildiğinde bu dosya ile ilgili bütün kayıtlar silinecektir.</p>
                            <form action="" method="POST">
                                @csrf
