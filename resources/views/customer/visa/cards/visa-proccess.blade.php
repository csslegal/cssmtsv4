            ...
            <div class="col-lg-4 col-md-6 col-sm-6 ">
                <div class="card border-primary mb-2">
                    <div class="card-body">
                        ...
                        data-content="Devam edilsin mi?" href="vize/{{ $visaFileDetail->id }}/odeme"> İşleme Git</a>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 col-sm-6 ">
                <div class="card border-success mb-2">
                    <div class="card-body">
                        ...
                        <a class="confirm btn btn-success btn-sm float-end text-white" data-title="Dikkat!"
                        data-content="Devam edilsin mi?" href="vize/{{ $visaFileDetail->id }}/makbuz"> İşleme Git</a>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 col-sm-6 ">
                <div class="card border-danger mb-2">
                    <div class="card-body">
                        ...
                        data-content="Devam edilsin mi?" href="vize/{{ $visaFileDetail->id }}/fatura"> İşleme Git</a>
                    </div>
                </div>
            </div>
        @endif
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 ">
                    <div class="card border-danger mb-2">
                        <div class="card-body">
                            ...
                            <a class="confirm btn btn-danger btn-sm float-end text-white" data-title="Dikkat!"
                            data-content="Devam edilsin mi?" href="vize/{{ $visaFileDetail->id }}/kapat"> İşleme Git</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-6 ">
                    <div class="card border-success mb-2">
                        <div class="card-body">
                            ...
                            <a class="confirm btn btn-success btn-sm float-end text-white" data-title="Dikkat!"
                            data-content="Devam edilsin mi?" href="vize/{{ $visaFileDetail->id }}/arsive-tasima"> İşleme Git</a>
                        </div>
                    </div>
                </div>
            @endif
